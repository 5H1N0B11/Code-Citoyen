...
BIAS_LIST = {
    ...
    "Homme de Paille (Straw Man)": "Consiste à travestir, exagérer ou caricaturer l'argument de son adversaire pour le rendre beaucoup plus facile à attaquer ou à ridiculiser.",
    "Fausse Équivalence (False Equivalence)": "Faire une équivalence morale ou logique entre deux choses qui ont des différences fondamentales majeures, souvent pour minimiser la gravité de l'une d'elles.",
    "Objection Triviale (Nitpicking)": "Rejeter l'entièreté d'un argument ou d'un fait factuel en se concentrant sur une erreur mineure, anecdotique ou non pertinente (ex: discréditer un accident mortel parce que la couleur de la voiture citée était fausse).",
